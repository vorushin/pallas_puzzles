...
# | Concept | Puzzle |
# |---------|--------|
# | `PrefetchScalarGridSpec` + SMEM | 1 |
# | `make_group_metadata` (CSR mapping) | 2 |
# | Configure scalar-prefetch `pallas_call` | 3 |
# | `get_store_mask`, `broadcasted_iota` | 4 |
# | Softmax kernel | 5 |
# | Simple grouped matmul (gmm) | 6 |
# | Full ragged_dot with masking | 7 |
# | tgmm, `pl.num_programs`, prologue/epilogue | 8 |
# | `emit_pipeline` for pipelining | 9 |
#
# Concepts from **basics.py** (prerequisites):
#
# | Concept | basics.py Puzzle |
# |---------|-----------------|
# | `pallas_call`, Refs, `ref[...]` syntax | 1 |
# | `grid`, `BlockSpec`, `program_id` | 2a, 3 |
# | Index map manipulation | 2b |
# | Broadcasting inside kernels | 4 |
# | Configure your own `pallas_call` | 5, 8 |
...
# - **Activation fusion**: apply ReLU/tanh after the dot (basics.py Puzzle 10)
